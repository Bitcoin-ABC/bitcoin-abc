...
class SignRawTransactionsTest(BitcoinTestFramework):
    ...
    def successful_signing_test(self):
        ...
        inputs = [
            ...
            {'utxid': '9b907ef1e3c26fc71fe4a4b3580bc75264112f95050014157059c736f0202e71',
             'vout': 0, 'amount': 3.14159,
             'scriptPubKey': '76a91460baa0f494b38ce3c940dea67f3804dc52d1fb9488ac'},
            {'utxid': '83a4f6a6b73660e13ee6cb3c6063fa3759c50c9b7521d0536022961898f4fb02',
    ...
    def script_verification_error_test(self):
        ...
        inputs = [
            ...
            {'utxid': '9b907ef1e3c26fc71fe4a4b3580bc75264112f95050014157059c736f0202e71',
             'vout': 0, 'amount': 0},
            # Invalid script
            {'utxid': '5b8673686910442c644b1f4993d8f7753c7c8fcb5c87ee40d56eaeef25204547',
             'vout': 7, 'amount': '1.1'},
        ...
        for i, inp in enumerate(inputs):
            assert_equal(decodedRawTx["vin"][i]["utxid"], inp["utxid"])
        ...
        assert 'utxid' in rawTxSigned['errors'][0]
        ...
        # input (vin 2)
        assert_equal(rawTxSigned['errors'][0]['utxid'], inputs[1]['utxid'])
        assert_equal(rawTxSigned['errors'][0]['vout'], inputs[1]['vout'])
        assert_equal(rawTxSigned['errors'][1]['utxid'], inputs[2]['utxid'])
