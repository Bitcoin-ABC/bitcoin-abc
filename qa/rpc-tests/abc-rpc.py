...
# Exercise the Bitcoin XBC RPC calls.
...
class ABC_RPC_Test (BitcoinTestFramework):
    ...
    def test_excessiveblock(self):
        ...
        self.check_subversion("/Bitcoin XBC:.*\(EB2\.0; .*\)/")
        ...
        # Check for EB correctness in the subver string
        self.check_subversion("/Bitcoin XBC:.*\(EB13\.0; .*\)/")
        ...
        # check for EB correctness in the subver string
        self.check_subversion("/Bitcoin XBC:.*\(EB13\.1; .*\)/")
