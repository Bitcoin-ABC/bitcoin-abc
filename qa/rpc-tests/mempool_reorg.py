...
class MempoolCoinbaseTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        spend_101_raw = create_tx(
            self.nodes[0], coinbase_txids[1], node1_address, 49.99, "ALL|FORKID")
        spend_102_raw = create_tx(
            self.nodes[0], coinbase_txids[2], node0_address, 49.99, "ALL|FORKID")
        spend_103_raw = create_tx(
            self.nodes[0], coinbase_txids[3], node0_address, 49.99, "ALL|FORKID")
        ...
        spend_102_1_raw = create_tx(
            self.nodes[0], spend_102_id, node1_address, 49.98, "ALL|FORKID")
        spend_103_1_raw = create_tx(
            self.nodes[0], spend_103_id, node1_address, 49.98, "ALL|FORKID")
