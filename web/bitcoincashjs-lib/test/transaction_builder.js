...
describe('TransactionBuilder', function () {
                    ...
                    input.signs.forEach(function (sign) {
                        ...
                        if (tx) {
                            ...
                            if (sign.filterOP_0) {
                                ...
                                var replacement =
                                    btemplates.scriptHash.input.encode(
                                        btemplates.multisig.input.encode(
                                            signatures,
                                        ),
                                        redeemScript,
                                    );
    ...
    describe('various edge case', function () {
        ...
        it('should warn of high fee for segwit transaction based on VSize, not Size', function () {
            ...
            var txb = TransactionBuilder.fromTransaction(
        ...
        it('should not classify blank scripts as nonstandard', function () {
            ...
            // and, repeat
            tx = TransactionBuilder.fromTransaction(
