...
var BLOCKTRAIL_API_KEY =
    process.env.BLOCKTRAIL_API_KEY ||
    'c0bd8155c66e3fb148bb1664adc1e4dacd872548';
var blockchain = new Blockchain('https://api.blocktrail.com/cb/v0.2.1/tBTC', {
    api_key: BLOCKTRAIL_API_KEY,
});
var kpNetwork = bitcoin.networks.testnet;
var keyPair = bitcoin.ECPair.fromWIF(
    'cQqjeq2rxqwnqwMewJhkNtJDixtX8ctA4bYoWHdxY4xRPVvAEjmk',
    kpNetwork,
);
