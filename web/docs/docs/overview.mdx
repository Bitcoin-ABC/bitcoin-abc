...
Cashtab is an eCash (XEC) web wallet available at https://cashtab.com/

# Getting Started

## Use Cashtab as a mobile app

1. Navigate to https://cashtab.com/ in your web browser on your mobile device
...
1. Navigate to https://cashtab.com/ on your desktop or mobile device.
...
3. Input your token name, ticker, decimal places, supply, and URL. If you do not enter a URL, the app will default to "https://cashtab.com/"
