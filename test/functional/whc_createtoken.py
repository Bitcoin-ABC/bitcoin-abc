...
class WHC_CreateToken_Test(BitcoinTestFramework):
    ...
    def token_create_test(self):
        ...
        payload = self.nodes[0].whc_createpayload_issuancefixed(1, 2, 0, "niha", "sww", "wnw", "www.sadqw",
                                                                "wshhgdygwq", "123721.15")

        pecosystem = payload[:9] + "4" + payload[10:]
        print("payload >>>", payload)
        print("pecosystem >>", pecosystem)
