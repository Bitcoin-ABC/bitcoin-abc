...
class TestNode():
    ...
    def start(self):
        ...
        self.process = subprocess.Popen(
            self.args + self.extra_args, stderr=self.stderr)
        self.running = True
    ...
    def wait_for_rpc_connection(self):
        ...
        for _ in range(poll_per_s * self.rpc_timeout):
            ...
            try:
                self.rpc = get_rpc_proxy(rpc_url(
                    self.datadir, self.index, self.rpchost), self.index, coveragedir=self.coverage_dir)
