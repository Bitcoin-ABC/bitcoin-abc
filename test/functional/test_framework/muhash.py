...
def rot32(v, bits):
    ...
    # Make sure the term below does not throw an exception
    bits %= 32
...
def chacha20_doubleround(s):
    ...
    See https://cr.yp.to/chacha/chacha-20080128.pdf and
...
def chacha20_32_to_384(key32):
    """Specialized ChaCha20 implementation with 32-byte key, 0 IV,
    384-byte output."""
...
def data_to_num3072(data):
    """Hash a 32-byte array data to a 3072-bit number using 6 Chacha20
    operations."""
...
class MuHash3072:
    ...
    See https://cseweb.ucsd.edu/~mihir/papers/inchash.pdf and
    ...
    def insert(self, data):
        ...
        self.numerator = (
            self.numerator * data_to_num3072(data)) % self.MODULUS

    def remove(self, data):
        """Remove a byte array from the set."""
        self.denominator = (
            self.denominator * data_to_num3072(data)) % self.MODULUS

    def digest(self):
        """Extract the final hash. Does not modify this object."""
        val = (self.numerator *
               modinv(self.denominator, self.MODULUS)) % self.MODULUS
...
class TestFrameworkMuhash(unittest.TestCase):
    def test_muhash(self):
        ...
        self.assertEqual(
            finalized[::-1].hex(),
            "a44e16d5e34d259b349af21c06e65d653915d2e208e4e03f389af750dc0bfdc3")
