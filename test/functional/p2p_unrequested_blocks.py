...
class AcceptBlockTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        self.num_nodes = 2
        self.extra_args = [["-noparkdeepreorg"], ["-minimumchainwork=0x10"]]
    ...
    def run_test(self):
        ...
        block_h3 = create_block(
            block_h2f.hash_int, create_coinbase(3), block_h2f.nTime + 1
        )
        block_h3.solve()
        ...
        for i in range(288):
            next_block = create_block(
                tip.hash_int, create_coinbase(i + 4), tip.nTime + 1
            )
            next_block.solve()
        ...
        block_289f = create_block(
            all_blocks[284].hash_int, create_coinbase(289), all_blocks[284].nTime + 1
        )
        block_289f.solve()
        block_290f = create_block(
            block_289f.hash_int, create_coinbase(290), block_289f.nTime + 1
        )
        block_290f.solve()
        ...
        block_292 = create_block(
            block_291.hash_int, create_coinbase(292), block_291.nTime + 1
        )
        block_292.solve()
        ...
        block_293 = create_block(
            block_292.hash_int, create_coinbase(293), block_292.nTime + 1
        )
        block_293.solve()
        headers_message = msg_headers()
