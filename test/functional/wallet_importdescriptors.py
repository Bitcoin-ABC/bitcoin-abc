...
class ImportDescriptorsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[1].createwallet(
            wallet_name="w1", disable_private_keys=True, blank=True, descriptors=True
        )
        ...
        test_address(
            w1, key.p2pkh_addr, solvable=True, ismine=True, labels=["Updated label"]
        )
        ...
        self.log.info(
            "Should not treat individual keys from the imported bare multisig as"
            " watchonly"
        )
        ...
        self.test_importdesc(
            {"desc": descsum_create(desc), "timestamp": "now", "range": [0, 100]},
            success=False,
            error_code=-4,
            error_message=(
        ...
        self.log.info(
            "Should not import a ranged descriptor that includes xpriv into a"
            " watch-only wallet"
        )
        ...
        self.log.info(
            "Should not import a descriptor with hardened "
        ...
        self.test_importdesc(
            {"desc": descsum_create(desc), "timestamp": "now", "range": [-1, 10]},
            success=False,
            error_code=-8,
        ...
        self.test_importdesc(
            {"desc": descsum_create(desc), "timestamp": "now", "range": [0, 1000001]},
            success=False,
            error_code=-8,
        ...
        assert_equal(wpriv.getwalletinfo()["keypoolsize"], 0)
        assert_raises_rpc_error(
            -4, "This wallet has no available keys", wpriv.getnewaddress, ""
        )
        ...
        assert_raises_rpc_error(
            -4, "This wallet has no available keys", wpriv.getrawchangeaddress
        )
        ...
        self.test_importdesc(
            {
                "desc": descsum_create(f"sh(pkh([abcdef12/0h/0h]{xpub}/*))"),
                "active": True,
                "range": [0, 2],
                "timestamp": "now",
            },
        ...
        for i, expected_addr in enumerate(addresses):
            ...
            assert_equal(pkh_addr_info["desc"][:22], f"pkh([12345678/0'/0'/{i}]")
        ...
        self.test_importdesc(
            {
                "desc": descsum_create(f"pkh([12345678/1h]{xpub}/*)"),
                "range": [0, 2],
                "timestamp": "now",
                "internal": True,
            },
        ...
        self.test_importdesc(
            {
                "desc": descsum_create(f"pkh([12345678]{xpub}/*)"),
                "range": [0, 5],
                "active": True,
                "timestamp": "now",
                "internal": True,
        ...
        assert_equal(address, "ecregtest:qp0v86h53rc92hjrlpwzpjtdlgzsxu25svv6g40fpl")
        ...
        tx = wpriv.createrawtransaction(
            [{"txid": txid, "vout": 0}], {w0.getnewaddress(): 49999000}
        )
        ...
        self.test_importdesc(
            {
                "desc": f"sh(multi(2,{xprv1}/84h/0h/0h/*,{xprv2}/84h/0h/0h/*,{xprv3}/84h/0h/0h/*))#f5nqn4ax",
                "active": True,
                "range": 1000,
                "next_index": 0,
                "timestamp": "now",
        ...
        self.test_importdesc(
            {
                "desc": f"sh(multi(2,{xprv1}/84h/1h/0h/*,{xprv2}/84h/1h/0h/*,{xprv3}/84h/1h/0h/*))#m4e4s5de",
                "active": True,
                "internal": True,
                "range": 1000,
                "next_index": 0,
        ...
        assert_equal(addr, "ecregtest:pzkcf26dw7np58jcspnpxaupgz9csnc3wsf5wdh2a3")
        ...
        self.test_importdesc(
            {
                "desc": f"sh(multi(2,[7b2d0242/84h/0h/0h]{acc_xpub1}/*,[59b09cd6/84h/0h/0h]{acc_xpub2}/*,[e81a0532/84h/0h/0h]{acc_xpub3}/*))#x75vpsak",
                "active": True,
                "range": 1000,
                "next_index": 0,
                "timestamp": "now",
        ...
        self.test_importdesc(
            {
                "desc": f"sh(multi(2,[7b2d0242/84h/1h/0h]{chg_xpub1}/*,[59b09cd6/84h/1h/0h]{chg_xpub2}/*,[e81a0532/84h/1h/0h]{chg_xpub3}/*))#v0t48ucu",
                "active": True,
                "internal": True,
                "range": 1000,
                "next_index": 0,
        ...
        assert_equal(addr, "ecregtest:pr5xql8r03jp5dvrep22dns59vf7hhykr5nmaucy2h")
        ...
        txid2 = w0.sendtoaddress(addr2, 10_000_000)
        ...
        res = wmulti_priv1.importdescriptors(
            [
                {
                    "desc": descsum_create(
                        f"sh(multi(2,{xprv1}/84h/0h/0h/*,[59b09cd6/84h/0h/0h]{acc_xpub2}/*,[e81a0532/84h/0h/0h]{acc_xpub3}/*))"
                    ),
                    "active": True,
                    "range": 1000,
                    "next_index": 0,
                ...
                {
                    "desc": descsum_create(
                        f"sh(multi(2,{xprv1}/84h/1h/0h/*,[59b09cd6/84h/1h/0h]{chg_xpub2}/*,[e81a0532/84h/1h/0h]{chg_xpub3}/*))"
                    ),
                    "active": True,
                    "internal": True,
                    "range": 1000,
        ...
        res = wmulti_priv2.importdescriptors(
            [
                {
                    "desc": descsum_create(
                        f"sh(multi(2,[7b2d0242/84h/0h/0h]{acc_xpub1}/*,{xprv2}/84h/0h/0h/*,[e81a0532/84h/0h/0h]{acc_xpub3}/*))"
                    ),
                    "active": True,
                    "range": 1000,
                    "next_index": 0,
                ...
                {
                    "desc": descsum_create(
                        f"sh(multi(2,[7b2d0242/84h/1h/0h]{chg_xpub1}/*,{xprv2}/84h/1h/0h/*,[e81a0532/84h/1h/0h]{chg_xpub3}/*))"
                    ),
                    "active": True,
                    "internal": True,
                    "range": 1000,
        ...
        res = wmulti_priv3.importdescriptors(
            [
                {
                    "desc": descsum_create(
                        f"sh(multi(2,{xprv1}/84h/0h/0h/*,[59b09cd6/84h/0h/0h]{acc_xprv2}/*,[e81a0532/84h/0h/0h]{acc_xpub3}/*))"
                    ),
                    "active": True,
                    "range": 1000,
                    "next_index": 0,
        ...
        rawtx = self.nodes[1].createrawtransaction(
            [{"txid": txid2, "vout": vout2}], {w0.getnewaddress(): 9_999_000}
        )
        ...
        self.test_importdesc(
            {
                "desc": descsum_create(f"combo({acc_xpub1}/*)"),
                "active": True,
                "range": 1,
                "timestamp": "now",
            },
        ...
        self.test_importdesc(
            {
                "desc": descsum_create(f"pk({acc_xpub1}/*)"),
                "active": True,
                "range": 1,
                "timestamp": "now",
            },
