...
class CompactBlocksConnectionTest(BitcoinTestFramework):
    ...
    def relay_block_through(self, peer):
        """Relay a new block through peer peer, and return HB status between 1 and
        [2,3,4,5]."""
    ...
    def run_test(self):
        ...
        # Now relay one block through peer 2 (outbound from node 1), so it should take
        # HB status from one of the inbounds.
