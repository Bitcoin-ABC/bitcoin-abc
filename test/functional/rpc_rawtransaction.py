...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # 10000 sat fee
        outputs = {self.nodes[0].getnewaddress(): Decimal("0.999990000")}
        rawTx = self.nodes[2].createrawtransaction(inputs, outputs)
        rawTxSigned = self.nodes[2].signrawtransactionwithwallet(rawTx)
        assert_equal(rawTxSigned['complete'], True)
        # 10000 sat fee, ~200 b transaction, fee rate should land around 50 sat/b = 0.00050000 BCH/kB
        ...
        rawTxSigned = self.nodes[2].signrawtransactionwithwallet(rawTx)
        assert_equal(rawTxSigned['complete'], True)
        # 2000000 sat fee, ~100 b transaction, fee rate should land around 20000 sat/b = 0.20000000 BCH/kB
        # Thus, testmempoolaccept should reject
