...
class WHC_Stobound_Test(BitcoinTestFramework):
    def set_test_params(self):
        self.num_nodes = 1
        self.tip = None
        self.setup_clean_chain = True

    def stobound_test(self):
        ...
        tx1 = self.nodes[0].whc_sendissuancefixed(addr0, 1, 3, 0, "dqw", "dwgyw", "ghsdy", "www.bndsyg", "csacbqyge", "100000000")
        self.nodes[0].generatetoaddress(1, addr0)
        ...
        tx3 = self.nodes[0].whc_createrawtx_reference(tx2, addr1, float(spent["amount"]) - 0.05)
