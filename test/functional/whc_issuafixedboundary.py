...
class WHC_CreateIssuanceFixed_Test(BitcoinTestFramework):
    ...
    def token_create_test(self):
        ...
        comtx = self.nodes[0].whc_createrawtx_reference(optx, addr0, "49.99")
        ...
        print("invalidreason : ", ret["invalidreason"])
...
if __name__ == '__main__':
    WHC_CreateIssuanceFixed_Test().main()
