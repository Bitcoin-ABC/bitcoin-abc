...
KNOWN_VIOLATIONS=(
    ...
    # Append the opening parenthesis to avoid shadowing strtoull with grep
    "src/utilstrencodings.cpp:.*strtoul\("
    "src/utilstrencodings.cpp:.*strtoull"
    "src/utilstrencodings.h:.*atoi"
)

REGEXP_IGNORE_EXTERNAL_DEPENDENCIES="src/(crypto/ctaes/|leveldb/|secp256k1/|seeder/|tinyformat.h|univalue/)"
