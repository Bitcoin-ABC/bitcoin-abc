...
#ifdef ENABLE_MODULE_SCHNORR
    printf("    - eCash Schnorr signatures (optional module)\n");
#endif

#ifdef ENABLE_MODULE_SCHNORRSIG
    printf("    - Taproot Schnorr signatures (optional module)\n");
#endif
...
#ifdef ENABLE_MODULE_SCHNORR
    printf("    schnorr        : all eCash Schnorr signature algorithms (sign, verify)\n");
    printf("    schnorr_sign   : eCash Schnorr sigining algorithm\n");
    printf("    schnorr_verify : eCash Schnorr verification algorithm\n");
#endif
...
#ifdef ENABLE_MODULE_SCHNORR
    if (d || have_flag(argc, argv, "schnorr") || have_flag(argc, argv, "verify") || have_flag(argc, argv, "schnorr_verify")) {
