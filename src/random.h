 ...
 *
 * - GetRandBytes, GetRandHash, GetRandDur, as well as construction of
 ...
 * loops).
 *
 * - The GetStrongRandBytes() function performs 'slow' seeding, including
 ...
 *
 * In test mode (see SeedRandomForTest in src/test/util/random.h), the normal
 * PRNG state is bypassed, and a deterministic, seeded, PRNG is used instead.
 *
 * Thread-safe.
 */
 ...
 * - RandomMixin:            a base class that adds functionality to all RNG
 *                           classes.
 * - FastRandomContext:      a cryptographic RNG (seeded through GetRandBytes
