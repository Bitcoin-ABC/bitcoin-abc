...
public:
    ...
    // Load root certificate authorities. Pass NULL (default) to read from the
    // file specified in the -rootcertificates setting, or, if that's not set,
    // to use the system default root certificates. If you pass in a store, you
    // should not X509_STORE_free it: it will be freed either at exit or when
    // another set of CAs are loaded.
