...
#define DVT_UI_H
    ...
    static const QString s_Dark = "rgb(50,50,50)"; // #323232
    static const QString s_Light = "rgb(211,211,211)";
    static const QString s_white = "rgb(255,255,255)";

    static const QString s_hightlight_dark = "rgba(30,30,30)";
    static const QString s_hightlight_darkest = "rgba(15,15,15)";

    static const QString s_highlight_light_midgrey = "rgba(60,60,60)"; // #3C3C3C
    static const QString s_highlight_dark_midgrey = "rgba(47,47,47)";
    static const QString s_highlight_light_blue = "rgb(22,185,255)"; // #16B9FF
    static const QString s_highlight_dark_blue = "rgb(2,90,155)"; // #025A9B
    ...
    static const QColor c_Light = QColor(211,211,211);
    static const QColor c_white = QColor(255,255,255);

    static const QColor c_hightlight_dark = QColor(30,30,30);

    static const QColor c_highlight_light_midgrey = QColor(60,60,60);
