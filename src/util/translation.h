...
// Provide an overload of tinyformat::format which can take bilingual_str
// arguments.
...
bilingual_str format(const bilingual_str &fmt, const Args &...args) {
    const auto translate_arg{
        [](const auto &arg, [[maybe_unused]] bool translated) -> const auto & {
    ...
    return bilingual_str{
        tfm::format(fmt.original, translate_arg(args, false)...),
