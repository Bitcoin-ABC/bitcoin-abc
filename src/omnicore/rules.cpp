...
CMainConsensusParams::CMainConsensusParams()
{
    ...
    WHC_FREEZENACTIVATE_BLOCK = 551750;
    // Script related:
    PUBKEYHASH_BLOCK = 0;
    ...
    MSC_STO_DISABLE_BURNADDR = 551750;
...
CTestNetConsensusParams::CTestNetConsensusParams()
{
    ...
    WHC_FREEZENACTIVATE_BLOCK = 1261950;
    // Script related:
    PUBKEYHASH_BLOCK = 0;
    SCRIPTHASH_BLOCK = 0;
    MULTISIG_BLOCK = 0;
    ...
    MSC_STO_BLOCK = 0;
    MSC_STO_DISABLE_BURNADDR = 1261950;
    MSC_METADEX_BLOCK = 0;
