...
BOOST_AUTO_TEST_CASE(ecosystem_restrictions_main)
{
    ...
    BOOST_CHECK(!IsTransactionTypeAllowed(0, OMNI_PROPERTY_WHC, MSC_TYPE_OFFER_ACCEPT_A_BET, MP_TX_PKT_V0));
    BOOST_CHECK(IsTransactionTypeAllowed(0, OMNI_PROPERTY_TWHC, MSC_TYPE_OFFER_ACCEPT_A_BET, MP_TX_PKT_V0));
}
...
BOOST_AUTO_TEST_CASE(update_feature_network)
{
    ...
    BOOST_CHECK(!IsTransactionTypeAllowed(newActivationBlock, OMNI_PROPERTY_WHC, MSC_TYPE_OFFER_ACCEPT_A_BET, MP_TX_PKT_V0));
