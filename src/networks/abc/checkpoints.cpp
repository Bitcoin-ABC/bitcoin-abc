...
static CCheckpointData mainNetCheckpointData = {
    .mapCheckpoints = {
        ...
        // Axion activation.
        {661648,
         *BlockHash::FromHex("000000000000000004284c9d8b2c8ff731efeaec6b"
                             "e50729bdc9bd07f910757d")},
        {664198,
         *BlockHash::FromHex("00000000000000000c2f90578cede892ff39592cce"
        ...
        {713661,
         *BlockHash::FromHex("00000000000000000676f84307c7ccb53a0f19083f"
                             "eace753cb73a38eaaaef8d")},
        // Gluon activation.
        {739536,
         *BlockHash::FromHex("000000000000000006db04cd4609560905fe5a7be6"
                             "2f2429b159ce6b59fc7b61")},
        // Jefferson activation.
        {766195,
         *BlockHash::FromHex("0000000000000000102bc94853715b9ade9610eb31"
                             "b4ed7d955529b76d24e094")},
        // Wellington activation.
        {792118,
         *BlockHash::FromHex("00000000000000000b360176b8456de45b662fce6d"
                             "557c6238dec17362d197f3")},
        // Cowperthwaite activation.
        {818670,
         *BlockHash::FromHex("000000000000000003e79cfe757a675909fd2bffde"
                             "52158ce4ec826e5ac6ae79")},
        // Lee Kuan Yew activation.
        {844743,
         *BlockHash::FromHex("0000000000000000053b80210677e6821a2ac0ed73"
                             "b949a78667e1bfb3dfa6eb")},
        // Augusto activation.
        {871168,
         *BlockHash::FromHex("0000000000000000232d2ec92c9a2dd3a6e887dabc"
                             "254c85f10e804239ff7274")},
        // Schumpeter activation.
        {896974,
         *BlockHash::FromHex("0000000000000000051b048b2d7801b854dbbe3fcd"
                             "f8f28e995d2bbbd29e7cf5")},
        // Shibusawa activation.
        {923348,
         *BlockHash::FromHex("00000000000000004eb0a7a410071b9ff243ed02ea"
                             "61ce3d566081dd05c05576")},
        // Obolensky activation.
        {949200,
         *BlockHash::FromHex("000000000000000098694560815190dba8bbe2f06c"
...
static CCheckpointData testNetCheckpointData = {
    .mapCheckpoints = {
        ...
        // Axion activation.
        {1421481,
         *BlockHash::FromHex("00000000062c7f32591d883c99fc89ebe74a83287"
                             "c0f2b7ffeef72e62217d40b")},
        // Tachyon activation.
        {1450540,
         *BlockHash::FromHex("00000000001085419e7328a2bacaf6216dd913c40"
                             "0f0b7da4bde43a8ebf6ed4e")},
        // Selectron activation.
        {1477500,
         *BlockHash::FromHex("000000000004057554e6f83253e3080774c37ae8a"
                             "940ffbc38d77525274709ae")},
        // Gluon activation.
        {1503557,
         *BlockHash::FromHex("00000000000dbd764814fb67b5ff5aab606faa1f5"
                             "881dc86f57639a1396e11ba")},
        // Jefferson activation.
        {1530063,
         *BlockHash::FromHex("00000000013102d35674688b5fd478c3a048660d6"
                             "fea862401734a4b914132bf")},
        // Wellington activation.
        {1556121,
         *BlockHash::FromHex("000000000eb806d6dbc9a200a9d533c7a11fc7d45"
                             "ab67a3c8440cc1b5c4e741f")},
        // Cowperthwaite activation.
        {1584486,
         *BlockHash::FromHex("000000000bdc9ee694295e611be29fcad7189f116"
                             "04edeb8f6c0ab65b40c3370")},
        // Lee Kuan Yew activation.
        {1608805,
         *BlockHash::FromHex("00000000000ad004602681a2458bc6304196ec483"
                             "f336cce7d031309e4d3592d")},
        // Augusto activation.
        {1635241,
         *BlockHash::FromHex("00000000082c7e223785dffb1f62db4ec737b8fd1"
                             "4faaf4dfb7c5a8bbf22bd2d")},
        // Schumpeter activation.
        {1661274,
         *BlockHash::FromHex("00000000000ec2a59f7dbddebfa9f5b82a918085d"
                             "d6174da26eb9d7ad005c219")},
        // Shibusawa activation.
        {1687664,
         *BlockHash::FromHex("00000000000a09cd4a16996bed7fb6afc58cb52f3"
                             "df7b1c8ce0bc90e5c56982f")},
        // Obolensky activation.
        {1713793,
         *BlockHash::FromHex("000000000008b5b5579ca088a51dd7ed18923e150"
