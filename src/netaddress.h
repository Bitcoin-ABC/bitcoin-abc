...
public:
     ...
     * @param[in] addrlen Length of sockaddr structure in bytes. This will be
     *     checked to exactly match the length of a socket address of the
     *     provided family, unless std::nullopt is passed
