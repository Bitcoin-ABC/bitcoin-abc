 ...
 *
 * seckey must point to an output buffer of length at least
 * CKey::SIZE bytes. seckeylen must initially be set to the size of
 * the seckey buffer. Upon return it will be set to the number of bytes used in
