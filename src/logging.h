...
private:
    ...
    void LogPrintStr_(std::string_view str, std::string_view logging_function,
                      std::string_view source_file, int source_line,
...
public:
    ...
    void LogPrintStr(std::string_view str, std::string_view logging_function,
                     std::string_view source_file, int source_line,
                     BCLog::LogFlags category, BCLog::Level level)
        EXCLUSIVE_LOCKS_REQUIRED(!m_cs);
...
static inline void
LogPrintf_(std::string_view logging_function, std::string_view source_file,
