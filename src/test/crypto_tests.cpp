...
struct CryptoTest : BasicTestingSetup {
    ...
    void TestChaCha20Poly1305(const std::string &plain_hex,
        ...
        for (int i = 0; i < 10; ++i) {
            ...
            // at prefix.
            size_t prefix =
                i ? m_rng.randrange(plain.size() + 1) : plain.size();
            // Encrypt.
    ...
    void TestFSChaCha20Poly1305(const std::string &plain_hex,
        ...
        for (int it = 0; it < 10; ++it) {
            ...
            // a split at prefix.
            size_t prefix =
                it ? m_rng.randrange(plain.size() + 1) : plain.size();
...
BOOST_AUTO_TEST_CASE(chacha20_testvector) {
    ...
    // The first one is identical to the above one from the RFC8439 A.1 vectors,
...
BOOST_AUTO_TEST_CASE(poly1305_testvector) {
        ...
        "f3ffc7703f9400e52a7dfb4b3d3305d9");
    {
        ...
        auto total_key = ParseHex<std::byte>(
            "01020304050607fffefdfcfbfaf9ffffffffffffffffffffffffffff00000000");
        ...
        BOOST_CHECK_EQUAL(HexStr(total_tag),
                          "64afe2e8d6ad7bbdd287f97c44623d39");
    }

    // Tests with sparse messages and random keys.
    TestPoly1305(
        "000000000000000000000094000000000000b07c4300000000002c002600d500"
    ...
    TestPoly1305(
        "0000005900000000c40000002f00000000000000000000000000000029690000"
...
BOOST_AUTO_TEST_CASE(chacha20poly1305_testvectors) {
    // Note that in our implementation, the authentication is suffixed to the
    // ciphertext. The RFC test vectors specify them separately.
    ...
    // Test vectors exercising aad and plaintext which are multiples of 16
    // bytes.
    TestChaCha20Poly1305(
    ...
    TestChaCha20Poly1305(
        ...
        {0x1f90da88, 0x75dafa3ef84471a4}, "aaae5bb81e8407c94b2ae86ae0c7efbe");
    ...
    TestFSChaCha20Poly1305(
        ...
        "5c9e1c3951a74fba66708bf9d2c217571684556b6a6a3573bff2847d38612654", 500,
