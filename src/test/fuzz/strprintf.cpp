...
FUZZ_TARGET(str_printf) {
    ...
    //
    // ()strprintf(format_string, (char*)nullptr);
    //
    // Upstream bug report: https://github.com/c42f/tinyformat/issues/70
    ...
    if (format_string.find('%') != std::string::npos &&
        ...
        // tinyformat.h:244:36: runtime error: 1.31783e+38 is outside the range
        // of representable values of type 'char'
        return;
    }
    ...
    if (format_string.find('%') != std::string::npos &&
        ...
        // tinyformat.h:283:65: runtime error: -2.33527e+38 is outside the range
        // of representable values of type 'int'
        // * strprintf("%*", -2147483648);
        // tinyformat.h:763:25: runtime error: negation of -2147483648 cannot be
