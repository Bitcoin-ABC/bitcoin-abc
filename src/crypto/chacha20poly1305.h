...
public:
     ...
     *
     * This is equivalent to Encrypt() with plain set to that many zero bytes,
     * and dropping the last EXPANSION bytes off the result.
     */
...
private:
    ...
    /**
     * Update counters (and if necessary, key) to transition to the next
     * message.
     */
