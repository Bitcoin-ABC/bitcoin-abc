...
export default {
    ...
    parseAddressInput: {
        expectedReturns: [
            ...
            {
                description:
                    'bip21 token: CACHET (SLP) send with input_data_raw for blitzchips roll (DICE lokad + bet range)',
                addressInput:
                    'ecash:qzqcq9p5lxa3jhc5lhwaefua9cjfhfjvcvsj887fg5?token_id=aed861a31b96934b88c0252ede135cb9700d7649f69191235087a3030e553cb1&token_decimalized_qty=10&input_data_raw=44494345000100000000e1f505',
                balanceSats: 50000000,
                userLocale: appConfig.defaultLocale,
                parsedAddressInput: {
                    address: {
                        value: 'ecash:qzqcq9p5lxa3jhc5lhwaefua9cjfhfjvcvsj887fg5',
                        error: false,
                    },
                    token_id: {
                        value: 'aed861a31b96934b88c0252ede135cb9700d7649f69191235087a3030e553cb1',
                        error: false,
                    },
                    token_decimalized_qty: {
                        value: '10',
                    ...
                    input_data_raw: {
                        error: false,
                        value: '44494345000100000000e1f505',
                    },
                    queryString: {
    ...
    getInputDataRawError: {
        expectedReturns: [
            {
                description:
                    'Valid DICE bet hex (13 bytes) for blitzchips roll is good',
                inputDataRaw: '44494345000100000000e1f505',
                returned: false,
            },
            {
                description: 'Valid hex of exactly 4 bytes (min) is good',
                inputDataRaw: '44494345',
                returned: false,
            },
            {
                description: 'Valid hex of 2 bytes is rejected (less than 4)',
                inputDataRaw: '4449',
                returned:
                    'input_data_raw must be at least 4 bytes (first 4 bytes are the lokad)',
            },
            {
                description: 'Empty string is rejected',
                inputDataRaw: '',
                returned: 'Cashtab will not send an empty input_data_raw',
            },
            {
                description: 'Valid hex of odd length is rejected',
                inputDataRaw: '44494345000100000000e1f5051',
                returned:
                    'input_data_raw input must be in hex bytes. Length of input must be divisible by two.',
            },
            {
                description: 'Uppercase hex is rejected',
                inputDataRaw: '44494345000100000000E1F505',
            ...
            {
                description: 'Valid hex exceeding 100 bytes is rejected',
                inputDataRaw: '01'.repeat(101),
                returned: 'input_data_raw exceeds 100 bytes',
            },
        ],
    },
    getFirmaPushError: {
