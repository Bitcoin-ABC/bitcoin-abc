...
export const walletWithBalancesMockNew = {
...
export const contextWithApiError = {
    wallet: walletWithXecAndTokens,
    cashtabCache,
    cashtabSettings,
    loading: false,
...
export const EmptyWalletWithHistoryMock = {
