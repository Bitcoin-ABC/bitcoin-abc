...
interface PathInfo_Pre_2_1_0 {
    publicKey: string;
    hash160: string;
    cashAddress: string;
    fundingWif: string;
}
interface Balances_Pre_2_1_0 {
...
interface Tokens_Pre_2_1_0 {
    tokenId: string;
    balance: string;
    info: LegacyTokenInfo;
}
interface CashtabWalletState_Pre_2_1_0 {
    balances: Balances_Pre_2_1_0;
    /**
     * NB, at this time in Cashtab history, utxos were also a different shape
     * However, we do not need to preserve this shape to run migrations, as
     * when these wallets are found, Cashtab just gets the latest utxos with
     * the latest shape
     *
     * So the mocks are stored in Cashtab with ScriptUtxo
     * */
    slpUtxos: ScriptUtxo[];
    nonSlpUtxos: ScriptUtxo[];
    tokens: Tokens_Pre_2_1_0[];
    /**
     * NB same thing for parsedTxHistory
     * These were a different shape at the time, but there is no need to support
     * migrations from this shape as we get tx history from latest shape
     */
    parsedTxHistory: CashtabTx[] | CashtabTxJson[];
}
export interface CashtabWallet_Pre_2_1_0 {
    mnemonic: string;
    name: string;
    Path145: PathInfo_Pre_2_1_0;
    Path245: PathInfo_Pre_2_1_0;
    Path1899: PathInfo_Pre_2_1_0;
    state: CashtabWalletState_Pre_2_1_0;
}

export const walletWithXecAndTokens_pre_2_1_0: CashtabWallet_Pre_2_1_0 = {
    mnemonic:
...
interface PathInfo_Pre_2_9_0 {
    path: number;
    address: string;
    hash: string;
    wif: string;
}
interface CashtabWalletState_Pre_2_9_0 {
    balanceSats: number;
    slpUtxos: ScriptUtxo[];
    nonSlpUtxos: ScriptUtxo[];
    tokens: Tokens_Pre_2_1_0[];
...
export interface CashtabWallet_Pre_2_9_0 {
    mnemonic: string;
    name: string;
    paths: PathInfo_Pre_2_9_0[];
    state: CashtabWalletState_Pre_2_9_0;
}
export const walletWithXecAndTokens_pre_2_9_0: CashtabWallet_Pre_2_9_0 = {
    mnemonic:
        'beauty shoe decline spend still weird slot snack coach flee between paper',
    name: 'Transaction Fixtures',
    ...
    state: {
        ...walletWithXecAndTokens_pre_2_1_0.state,
        balanceSats: 951312,
...
export interface PathInfo_Pre_2_55_0 {
    address: string;
    hash: string;
    wif: string;
}
...
export const walletWithXecAndTokens_pre_2_55_0: CashtabWallet_Pre_2_55_0 = {
    ...
    state: {
        balanceSats: walletWithXecAndTokens_pre_2_9_0.state.balanceSats,
        nonSlpUtxos: walletWithXecAndTokens_pre_2_9_0.state.nonSlpUtxos,
        slpUtxos: walletWithXecAndTokens_pre_2_9_0.state
            .slpUtxos as TokenUtxo[],
        tokens: new Map([
            [
                '3fee3384150b030490b7bee095a63900f66a45f2d8e3002ae2cf17ce3ef4d109',
                '1',
        ...
        parsedTxHistory: walletWithXecAndTokens_pre_2_9_0.state.parsedTxHistory,
    },
};
...
export const walletWithXecAndTokens_pre_3_41_0: LegacyCashtabWallet_Pre_3_41_0 =
    {
...
for (const unmigratedWallet of validSavedWallets_pre_2_1_0) {
    ...
    migratedWallet.state.balanceSats =
        'totalBalanceInSatoshis' in unmigratedWallet.state.balances
            ? parseInt(
                  (unmigratedWallet as unknown as CashtabWallet_Pre_2_1_0).state
...
export const validSavedWallets_pre_2_9_0: CashtabWallet_Pre_2_9_0[] =
    validSavedWalletsBuilder_pre_2_9_0;

const validSavedWalletsBuilder_pre_2_55_0: CashtabWallet_Pre_2_55_0[] = [];
for (const unmigratedWallet of validSavedWalletsBuilder_pre_2_9_0) {
    // Clone legacy wallet
    const migratedWallet: CashtabWallet_Pre_2_9_0 | CashtabWallet_Pre_2_55_0 = {
        ...unmigratedWallet,
    };
    ...
    migratedWallet.paths = new Map([
        [
            1899,
            {
                hash: unmigratedWallet.paths.find(
                    (pathInfo: PathInfo_Pre_2_9_0) => pathInfo.path === 1899,
                ).hash,
        ...
        [
            ...
            {
                hash: unmigratedWallet.paths.find(
                    (pathInfo: PathInfo_Pre_2_9_0) => pathInfo.path === 145,
                ).hash,
                address: unmigratedWallet.paths.find(
                    (pathInfo: PathInfo_Pre_2_9_0) => pathInfo.path === 145,
                ).address,
        ...
        [
            ...
            {
                hash: unmigratedWallet.paths.find(
                    (pathInfo: PathInfo_Pre_2_9_0) => pathInfo.path === 245,
                ).hash,
                address: unmigratedWallet.paths.find(
                    (pathInfo: PathInfo_Pre_2_9_0) => pathInfo.path === 245,
                ).address,
    ...
    validSavedWalletsBuilder_pre_2_55_0.push(
        migratedWallet as CashtabWallet_Pre_2_55_0,
    );
}
...
for (const unmigratedWallet of validSavedWallets_pre_2_1_0) {
    ...
    validSavedWalletsBuilder.push(migratedWallet as CashtabWallet_Pre_3_41_0);
}

export const validSavedWallets_pre_3_41_0 = validSavedWalletsBuilder;

const validSavedWalletsBuilderNew = [];
for (const w of validSavedWallets_pre_3_41_0) {
    const path = w.paths.get(1899);
    const { sk, pk, hash, address } = path as CashtabPathInfo;
    validSavedWalletsBuilderNew.push({
        mnemonic: w.mnemonic,
        name: w.name,
        address,
        hash,
...
export const validSavedWallets = validSavedWalletsBuilderNew;

const validActiveWalletsBuilder = [];
for (const w of validSavedWallets_pre_3_41_0) {
    const path = w.paths.get(1899);
    const { sk, pk, hash, address } = path as CashtabPathInfo;
    validActiveWalletsBuilder.push({
        name: w.name,
        mnemonic: w.mnemonic,
        address,
        hash,
...
export const validActiveWallets = validActiveWalletsBuilder;
