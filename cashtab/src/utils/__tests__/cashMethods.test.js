...
test('parseAddressForParams() returns expected object for a query string with simple amount param', () => {
    const inputString =
...
test('parseAddressForParams() returns expected object for a query string amount param having valid decimal places', () => {
    const inputString =
...
test('parseAddressForParams() returns null for all param amounts and expected error for a query string repeating the amount param', () => {
    const inputString =
...
test('parseAddressForParams() accepts a valid opreturn param', () => {
    const inputString =
...
test('parseAddressForParams() returns null for all params and expected error msg for an invalid opreturn param', () => {
    const inputString =
...
test('parseAddressForParams() accepts a valid opreturn param and a valid amount param', () => {
    const inputString =
...
test('parseAddressForParams() returns null for all param amounts and expected error for a query string repeating the opreturn param', () => {
    const inputString =
...
test('parseAddressForParams() returns expected error and no param amounts for a query string amount param having invalid decimal places', () => {
    const inputString =
...
test('parseAddressForParams() returns null for params and expected error msg if unsupported params are included in the string', () => {
    const inputString =
        'ecash:qq9h6d0a5q65fgywv4ry64x04ep906mdku8f0gxfgx?*&@^&%@amount=-500000';
    const expectedObject = {
        address: 'ecash:qq9h6d0a5q65fgywv4ry64x04ep906mdku8f0gxfgx',
