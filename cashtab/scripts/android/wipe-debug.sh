...
# Script to wipe Android storage for Cashtab dev app
# This clears all app data including wallets, settings, and cache

echo "⚠️  WARNING: This will completely wipe all Cashtab Dev app data!"
...
echo ""
echo "Wiping Cashtab Dev Android storage..."
...
# Clear the app data for dev flavor
echo "Clearing app data for com.cashtab.app.dev..."
if adb shell pm clear com.cashtab.app.dev; then
    echo "✅ Successfully wiped Cashtab Dev storage!"
