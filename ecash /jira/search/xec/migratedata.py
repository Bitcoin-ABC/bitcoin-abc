...
def update_config():
    ...
    # We no longer support the XEC Cash Address format in the GUI as of 5.1.7
    if config.get("address_format") == "CashAddr XEC":
    ...
    if config.get("use_exchange") == "CoinGeckoXECa":
        _logger.info("Updating the fiat exchange from CoinGeckoXeca to CoinGecko")
