#ifndef LIGHTNING_XEC_SIGNATURE_H
#define LIGHTNING_XEC_SIGNATURE_H
#include "config.h"
...
/**
 * xec_signature - signature with a sighash type.
 *
...
/**
 * xec_tx_hash_for_sig - produce hash for a transaction
 *
 * @tx - tx to hash
...
/**
 * sign_tx_input - produce a xec signature for a transaction input
 * @tx: the xec transaction we're signing.
...
/**
 * check_tx_sig - produce a xec signature for a transaction input
 * @tx: the xec transaction which has been signed.
...
#endif /* LIGHTNING_XEC_SIGNATURE_H */
