...
const applicationName = options.wallet ? 'xec Wallet' : 'Mist';
...
// Currently, Mist and xec Wallet expects ./wallet/ to be in different paths. This task aims to fulfill this requirement.
...
gulp.task('build-dist', cb => {
  const appPackageJson = _.extend({}, require('../package.json'), {
    ...
    license: 'GPL-3.0',
    homepage: 'https://github.com/xec/mist',
    build: {
      appId: `org.xec.${type}`,
      asar: true,
      directories: {
