...
struct channel *new_channel(struct peer *peer, u64 dbid,
			    ...
			    struct xec_tx *last_tx STEALS,
			    const struct xec_signature *last_sig,
			    /* NULL or stolen */
			    const struct xec_signature *last_htlc_sigs STEALS,
			    ...
			    /* NULL or stolen */
			    const struct xec_outpoint *shutdown_wrong_funding STEALS,
