...
"${CHECKPOINTS_SCRIPT}" --json-output "${CHECKPOINT_JSON_FILE_MAINNET}" --server electrum.bitcoinabc.org:50002:s
"${CHECKPOINTS_SCRIPT}" --json-output "${CHECKPOINT_JSON_FILE_TESTNET}" --server telectrum.bitcoinabc.org:60002:s
