...
* Universal Plug and Play support.  Enable automatic opening of a port for incoming connections by running bitcoin or bitcoinabc with the - -upnp=1 command line switch or using the Options dialog box.
...
* Several bug fixes, including a serious intermittent bug that would sometimes cause bitcoinabc to stop accepting rpc requests. 
