...
bitcoinabc/bitcoin-qt (on Linux).
...
This allows running bitcoinabc without having to do any manual configuration.
...
Bitcoinabc can now (optionally) asynchronously notify clients through a
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ...
        # optional bypass bitcoinabc rpc basic auth
...
Restarting bitcoinabc will no longer clear out the list of banned peers; instead
...
- #7209 `f3ad812` test: don't override BITCOINABC and BITCOINCLI if they're set (Wladimir J. van der Laan)
...
- #6401 `6db53b4` Add BITCOINABC_SIGTERM_TIMEOUT to OpenRC init scripts (Florian Schmaus)
