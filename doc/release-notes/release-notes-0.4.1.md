...
If you have a previously encrypted wallet.dat, the first time you run wxbitcoin or bitcoinabc the wallet will be rewritten, Bitcoin will
...
bitcoinabc: run the 'walletpassphrase' RPC command to unlock the wallet,  then run the 'getnewaddress' RPC command.
