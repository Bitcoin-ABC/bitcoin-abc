...
Bitcoin ABC has been updated to make use of this.

This means that if Tor is running (and proper authentication has been configured),
Bitcoin ABC automatically creates an onion service to listen on. This will positively
...
- Do not add anything but Bitcoin ABC ports to the onion service created in section 2.
