...
The official DeVault guide to backporting code from Bitcoin Core. When searching
...
3. Tag the fork commit as `fork-commit`. DeVault was forked from Bitcoin Core
...
Before you begin backporting commits, you will need to add an additional remote to your DeVault repo.
