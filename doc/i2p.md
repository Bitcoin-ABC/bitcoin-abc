...
The first time Bitcoin ABC connects to the I2P router, if
...
file named `i2p_private_key` in the Bitcoin ABC data directory. The persistent
...
If an I2P node is not accepting incoming connections, then Bitcoin ABC uses
...
I2P support was added to Bitcoin ABC in version 0.25.0 and there may be fewer I2P
...
There are several ways to see your I2P address in Bitcoin ABC if accepting
...
from programs which are connecting via the SAM proxy, e.g. Bitcoin ABC, you
